...
import styles from './update.module.css'; // Import the CSS module for styling
...
const UpdatedCard = ({ id, title, content, imageLink, postedAt }) => {
  const { formattedDate, formattedTime } = formatDate(postedAt)
  return (
    <div className={styles['news-card']} key={id}>
      <div className={styles['news-content']}> 
      <Image src={imageLink} alt={title} className={styles['news-image']} width={100} height={80}/>
